  ...
  (cl-labels ((join-regexps (regexps)
              ...
              (compile-regexps (regexps)
                (if regexps
                  ...
                  #'ignore))
              (match-trunk (s)
		(if (eq vc-trunk-branch-regexps t)
                    (not (match-topic s))
                  (funcall (compile-regexps vc-trunk-branch-regexps)
                           s)))
              (match-topic (s)
                (if (eq vc-topic-branch-regexps t)
                    (not (match-trunk s))
                  (funcall (compile-regexps vc-topic-branch-regexps)
                           s))))
